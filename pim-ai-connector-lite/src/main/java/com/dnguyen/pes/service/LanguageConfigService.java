 ...
 * Ermöglicht das Umschalten zwischen verschiedenen Sprachen (DE, EN) für Produktbeschreibungen.
 */
@Service
public class LanguageConfigService {
    ...
    public void init() {
        ...
        languageSystemMessages.put("de", "Du bist ein Produktbeschreibungs-Assistent. Deine Aufgabe ist es, ansprechende und verkaufsfördernde Beschreibungen zu erstellen. Antworte immer auf Deutsch, unabhängig von der Eingabesprache.");
        languageSystemMessages.put("en", "You are a product description assistant. Your task is to create appealing and sales-promoting descriptions. Always respond in English, regardless of the input language.");
        
        // Initialisiere Prompt-Suffixe für verschiedene Sprachen
        languagePromptSuffixes.put("de", "Erstelle eine verkaufsfördernde Beschreibung in deutscher Sprache. Verwende präzise deutsche Begriffe und eine ansprechende Sprache.");
        languagePromptSuffixes.put("en", "Create a sales-promoting description in English language. Use precise English terms and appealing language.");
